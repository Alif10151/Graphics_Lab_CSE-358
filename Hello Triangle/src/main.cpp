...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Abdullah - Al - Alif", NULL, NULL);
    if (window == NULL)
    {
    ...
    // ------------------------------------------------------------------
    float vertices[] = { 
        // first make two triangle that creates a perfect square and then add a triangle on top of square to make the desired shape
